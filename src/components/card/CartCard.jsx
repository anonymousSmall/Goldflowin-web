  ...
  return (
    <div>
      ...
      <div className="border p-2">
            ...
            <div className="flex justify-between mb-2">
              ...
              <div className="flex gap-2 items-center">
                {item.images && item.images.length > 0 ? (
                  ...
                  <div className="flex text-center items-center w-16 h-16 bg-gray-200 rounded-md">
                    No Image
                  </div>
                )}
                <div>
        ...
        {/* button */}
        <Link to={"/cart"}>
          <button className="mt-4 bg-green-500 text-white w-full py-2 rounded-md shadow-md hover:bg-green-600">
            ดำเนินการชำระเงิน
          </button>
        </Link>
      </div>
