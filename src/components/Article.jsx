...
return (
  <div className='pt-10 pb-20 text-center'>
    <div className='container mx-auto max-w-[1320px]'>
      <h3 className='text-[2.2rem] font-semibold text-[#4D4D4D]'>บริการของเรา</h3>
      <p className='text-[#717171]'>Our Service</p>
      
      <div className='my-10'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap10'>
          <div classNam='relative m-5 md:m-0'>
            <img className='rounded-xl' src={photo1}/>
              <div className='absolute bg-[#F5F7FA] bottom-[-50px] left-[50%] translate-x-[-50%] w-full max-w-[350px] p-5 shadow-lg rounded-xl'>
                <p className='font-bold text-[1.25rem] text-[#717171] mb-5'>บริษัท โกลโฟล อินสตรูเมนท์ จำกัด
          ...
          <div classNam='relative m-5 md:m-0'>
            <img className='rounded-xl' src={photo2}/>
              <div className='absolute bg-[#F5F7FA] bottom-[-50px] left-[50%] translate-x-[-50%] w-full max-w-[350px] p-5 shadow-lg rounded-xl'>
                <p className='font-bold text-[1.25rem] text-[#717171] mb-5'>บริษัท โกลโฟล อินสตรูเมนท์ จำกัด จำกัด
          ...
          <div classNam='relative m-5 md:m-0'>
            <img className='rounded-xl' src={photo4}/>
              <div className='absolute bg-[#F5F7FA] bottom-[-50px] left-[50%] translate-x-[-50%] w-full max-w-[350px] p-5 shadow-lg rounded-xl'>
                <p className='font-bold text-[1.25rem] text-[#717171] mb-5'>ให้บริการซ่อมเครื่องมือวัดต่างๆ
                  -PROFILE PROJECTOR
                  -VIDEO MEASURING
                  -เครื่องชั่งน้ำหนัก 
